...
import { authHeader } from "./serviceOrders.shared";
    ...
    (async () => {
      try {
        ...
        if (!res.ok) {
          ...
          setError(err.error || "Falha ao criar ordem de serviço");
          return;
        }
        const created = await res.json();
        navigate(`/admin/ordens-servico/${created.id}`, { replace: true });
      } catch {
        setError("Falha ao criar ordem de serviço");
      }
    })();
  }, [navigate]);
