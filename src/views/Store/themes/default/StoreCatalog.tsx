                    ...
                    {[
                      ...
                      return (
                        <button
                          key={label as string}
                          onClick={() => { }}
                          className="flex items-center justify-between w-full text-[10px] transition-colors py-1 text-stone-500 hover:text-amber-700"
                        >
                          <span className="font-medium">{label as string}</span>
                          <span className="text-[9px] px-1.5 py-0.5 rounded-full font-bold bg-amber-100 text-amber-600">{count}</span>
                        </button>
                      );
                    })}
                  </div>
