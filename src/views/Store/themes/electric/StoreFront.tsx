    ...
    <section className="relative isolate overflow-hidden bg-[#071426] text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 pb-14 pt-12 sm:px-8 md:grid-cols-[minmax(0,1.04fr)_minmax(360px,.96fr)] md:items-center md:py-16 lg:px-10 lg:py-20">
        <div className="max-w-2xl">
          ...
          <motion.h1 initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .55, delay: .08 }} className="max-w-xl text-4xl font-black leading-[.98] tracking-[-.06em] sm:text-5xl lg:text-6xl">Tudo para o seu projeto, <span className="text-transparent [background:linear-gradient(100deg,#6db7ff,#fff)] bg-clip-text">em um só lugar.</span></motion.h1>
