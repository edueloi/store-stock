// Raiz "Autoridade Certificadora Raiz Brasileira v10" (ICP-Brasil/ITI), publicada
// oficialmente em http://acraiz.icpbrasil.gov.br/ICP-Brasilv10.crt e referenciada pela
// extensão "Authority Information Access" da cadeia intermediária usada pela SEFAZ-SP
// e por outros serviços fiscais brasileiros. Sem ela, o Node não consegue validar a
// cadeia TLS desses hosts (erro "unable to get local issuer certificate"), pois essa
// raiz não faz parte do bundle padrão de CAs confiáveis do Node/Mozilla.
export const ICP_BRASIL_ROOT_CA = `-----BEGIN CERTIFICATE-----
